...
> Első futáskor a rembg egyszer letölti a kiválasztott modellt (az alap
> `birefnet-general` kb. 1 GB; a gyorsabb `u2net` kb. 170 MB). Utána már
...
| `--model <név>` | rembg modell: `birefnet-general` (**alap, legpontosabb élek** – ~1 GB, lassabb), `u2net` (gyorsabb, sok képhez, ~170 MB), `isnet-general-use` |
